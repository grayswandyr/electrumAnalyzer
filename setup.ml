...
(* OASIS_START *)
(* DO NOT EDIT (digest: 547e4a8ff866ecf3e43501133edd49a6) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            ...
            "-use-ocamlfind";
            "-cflags";
            "-safe-string,-strict-sequence,-short-paths";
            "-use-menhir -menhir 'menhir --infer --unused-token ALL --unused-token ARROW \\\n--unused-token SET'";
            "-pkgs";
            "pprint,menhirLib,batteries,cmdliner";
            "-j";
            "0"
         ];
     test = [];
     ...
     package =
       {
          ...
          findlib_version = Some (OASISVersion.VGreaterEqual "1.5.5");
          alpha_features =
            ["ocamlbuild_more_args"; "compiled_setup_ml"; "stdfiles_markdown"
            ];
          beta_features = [];
              ...
              (OASISLicense.DEP5Unit
                 {
                    ...
                    excption = None;
                    version = OASISLicense.VersionOrLater "3"
                 });
          license_file = Some "COPYING.txt";
          copyrights = ["(C) 2014-2015 Onera\n(C) 2015 IRIT"];
          maintainers =
            [
          ...
          homepage = Some "https://forge.onera.fr/projects/electrum";
          synopsis =
            "Translates Electrum models to a model-checker (as of now:\nfiles processable with NuSMV and nuXmv).";
          description =
            Some
              [
                 OASISText.Para
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Activate all compilation warnings.";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Activate profiling (native only).";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "electrumAnalyzer";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("pprint", None);
                           FindlibPackage
                             ("menhirLib",
                               Some (OASISVersion.VGreaterEqual "20150720"));
                           FindlibPackage ("str", None);
                           FindlibPackage ("batteries", None);
                           FindlibPackage
                             ("cmdliner",
                               Some (OASISVersion.VGreaterEqual "0.9.5"))
                        ];
                      ...
                      bs_nativeopt =
                        [
                           ...
                           (OASISExpr.EFlag "profiling", ["-p"]);
                           (OASISExpr.EFlag "warnings", ["-w"; "A"]);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "warnings",
                                OASISExpr.EFlag "profiling"),
                             ["-w"; "A"; "-p"])
                        ]
                   },
                   {exec_custom = false; exec_main_is = "electrumAnalyzer.ml"
                   });
               SrcRepo
                 ({
                     cs_name = "head";
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://git.onera.fr/electrum.git";
                      src_repo_browser =
                        Some "https://forge.onera.fr/projects/electrum";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/grayswandyr/electrumAnalyzer.git";
                      src_repo_browser =
                        Some
                          "https://github.com/grayswandyr/electrumAnalyzer";
                      src_repo_module = None;
                      src_repo_branch = Some "master";
                      src_repo_tag = None;
                      src_repo_subdir = None
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "O\148_\147\205\177Xm\146\215\027\169\131\031v\169";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
