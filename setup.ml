...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9a7a97f76539322f03bf70cde5b7bc35) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = ["david.chemouil+electrum@onera.fr"];
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("sh", ["util/prebuild.sh"])))
                 ];
               post_command =
                 [(OASISExpr.EBool true, Some (("$rm", ["src/build.ml"])))]
            };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\158\n9\136\159\203\217z|\150\254\027r\"\167\012";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
