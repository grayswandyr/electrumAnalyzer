...
pred Move [st: State, fromStake, toStake: Stake, s8: State] {
   ...
   // the "det" modifier above.  (It8s important to use the "det" modifier
   ...
   all preState: State - states/last |
       let postState = states/next[preState] |
          some fromStake: Stake | {
             ...
             some toStake: Stake | Move[preState, fromStake, toStake, postState]
          }
}
